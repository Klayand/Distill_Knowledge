...
from distiller import KD, CenterKernelAlignmentRKD, SPDISTCKA
...
distiller = SPDISTCKA(teacher=teacher_model, student=student_model, is_cka=True).to("cuda")
...
w.distill(train_loader, test_loader, total_epoch=500)
