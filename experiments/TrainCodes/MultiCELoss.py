...
from scheduler import ALRS, LambdaLR
...
class LearnWhatYouDontKnow:
    def __init__(
        ...
        self.scheduler = scheduler if scheduler is not None else LambdaLR(self.optimizer)
        self.device = device
    ...
    def train(
        ...
        for epoch in range(1, total_epoch + 1):
            ...
            print(f"epoch {epoch}, training_loss = {train_loss}, training_acc = {train_acc}")
